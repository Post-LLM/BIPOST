...
from bipost.datasets import SFTDataset, RewardDataset
from bipost.models import Actor
from bipost.trainer import SFT_Pref_Trainer
...
def train(args):
    ...
    train_dataset = RewardDataset(
        train_data, tokenizer, args.max_len, strategy, input_template=args.input_template, is_dpo=False #! will this work?
    )
    eval_dataset = RewardDataset(
        eval_data, tokenizer, args.max_len, strategy, input_template=args.input_template, is_dpo=False #! will this work?
    )
...
if __name__ == "__main__":
    ...
    # DeepSpeed
    parser.add_argument("--micro_train_batch_size", type=int, default=1, help="batch size per GPU") # dummy value to make sure grad. accum steps=1
    ...
    parser.add_argument("--wandb_project", type=str, default="bipost_sft_pref")
    parser.add_argument(
        "--wandb_run_name",
        type=str,
