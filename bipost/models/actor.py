    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(pretrain_or_model, str):
            ...
            if 'checkpoint' in pretrain_or_model:
                files = os.listdir(pretrain_or_model)
                for foo in files:
                    if "adapter" in foo:
                        print()
                        print(f"Loading adapter from {pretrain_or_model} ....")
                        self.model = PeftModel.from_pretrained(self.model, pretrain_or_model)
